...
public class OrderManager : MonoBehaviour
{
    ...
    // Stellt eine zuf�llige Bestellung zusammen
    ...
    // wird aufgerufen wenn ein d�ner korrekt abgegeben wurde
    public void OnCorrectOrderServed()
    {
        ...
        // timer f�r die n�chste bestellung zur�cksetzen
        currentTime = gameTime;
        warningPlayed = false;
        UpdateTimerDisplay();
    }
    ...
    // pr�fe ob die Zutaten korrekt sind
